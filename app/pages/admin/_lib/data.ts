...
export const initialSchemes: Scheme[] = [
  {
    ...
    eligibility: { allowedLivelihood: ["Working Professional", "Self-Employed", "Farmer"], allowedAreaType: ["Urban", "Rural", "Semi-Urban"] },
    eligibilityText: "Indian residents aged 18–65 with stable income.",
    recRate: 88, totalRecommended: 120, totalAccepted: 90,
    tag: "TERM · LIC", status: "active",
  },
  {
    id: "medicare-plus",
    ...
    recRate: 76, totalRecommended: 95, totalAccepted: 65,
    tag: "HEALTH · HDFC", status: "active",
  },
  {
    id: "wealthgrow-ulip",
    ...
    recRate: 54, totalRecommended: 80, totalAccepted: 40,
    tag: "INVESTMENT · SBI", status: "review",
  },
  {
    id: "secure-retire",
    ...
    eligibility: { allowedLivelihood: ["Working Professional", "Self-Employed", "Farmer"], requiresSeniorCitizen: false },
    eligibilityText: "Indian residents aged 25–60 planning for retirement.",
    recRate: 62, totalRecommended: 75, totalAccepted: 53,
    tag: "PENSION · LIC", status: "active",
  },
  {
    ...
    recRate: 58, totalRecommended: 60, totalAccepted: 39,
    tag: "HEALTH · STAR", status: "active",
  },
  {
    ...
    recRate: 22, totalRecommended: 30, totalAccepted: 5,
    tag: "CRITICAL · ICICI", status: "draft",
  },
  {
    id: "pm-jan-dhan",
    ...
    recRate: 70, totalRecommended: 110, totalAccepted: 80,
    tag: "WELFARE · GOVT", status: "active",
  },
  {
    id: "ppf-scheme",
    ...
    recRate: 80, totalRecommended: 100, totalAccepted: 75,
    tag: "SAVINGS · GOVT", status: "active",
  },
];

export const initialLogs: RecommendationLog[] = [
  { id: 1, name: "Rahul Kumar", initials: "RK", grad: "linear-gradient(135deg,#2563eb,#0891b2)", schemes: "ShieldMax Term Life + MediCare Plus", age: 34, income: "₹8L",  dep: 2, time: "4 mins ago",  score: 92, outcome: "accepted" },
  { id: 2, name: "Priya Mehta", initials: "PM", grad: "linear-gradient(135deg,#ea580c,#dc2626)", schemes: "WealthGrow ULIP",                     age: 28, income: "₹5L",  dep: 0, time: "18 mins ago", score: 61, outcome: "rejected" },
  { id: 3, name: "Arjun Singh", initials: "AS", grad: "linear-gradient(135deg,#7c3aed,#2563eb)", schemes: "SecureRetire Pension",                age: 52, income: "₹18L", dep: 3, time: "31 mins ago", score: 88, outcome: "accepted" },
  { id: 4, name: "Neha Joshi",  initials: "NJ", grad: "linear-gradient(135deg,#0891b2,#7c3aed)", schemes: "FamilyShield Group Health",           age: 41, income: "₹12L", dep: 4, time: "1 hr ago",    score: 74, outcome: "pending"  },
  { id: 5, name: "Vikram Rao",  initials: "VR", grad: "linear-gradient(135deg,#dc2626,#ea580c)", schemes: "CriticalCare Rider",                  age: 45, income: "₹22L", dep: 2, time: "2 hrs ago",   score: 55, outcome: "rejected" },
  { id: 6, name: "Sunita Kaur", initials: "SK", grad: "linear-gradient(135deg,#2563eb,#7c3aed)", schemes: "ShieldMax Term Life",                 age: 31, income: "₹6L",  dep: 1, time: "3 hrs ago",   score: 85, outcome: "accepted" },
];
...
export function generateStats(schemes: Scheme[], logs: RecommendationLog[]): StatCardData[] {
  ...
  return [
    { label: "Total Schemes",           value: String(totalSchemes),    change: `${activeSchemes} active`,    changeType: "up",                        color: "blue"   },
    { label: "Active Schemes",          value: String(activeSchemes),   change: `of ${totalSchemes} total`,   changeType: "up",                        color: "green"  },
    { label: "Acceptance Rate",         value: `${acceptanceRate}%`,    change: `${acceptedLogs} of ${totalRecommendations} logs`, changeType: acceptanceRate >= 60 ? "up" : "down", color: "orange" },
    { label: "Avg Recommendation Score",value: `${avgRecRate}%`,        change: avgRecRate >= 60 ? "Performing well" : "Needs review", changeType: avgRecRate >= 60 ? "up" : "warn", color: "red" },
  ];
}
